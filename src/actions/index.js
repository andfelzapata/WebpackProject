...
export const resetArtist = () => ({ type: RESET_ARTIST });

export const clearError = () => ({ type: CLEAR_ERROR });

export const selectArtist = id => ({ type: SELECT_ARTIST, payload: id });

export const deselectArtist = id => ({ type: DESELECT_ARTIST, payload: id });
